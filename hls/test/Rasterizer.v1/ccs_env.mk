ifeq "$(CXX_HOME)" ""
CXX_HOME                                              := /cad/mentor/2019.11/Catapult_Synthesis_10.4b-841621/Mgc_home
export CXX_HOME
endif
ifeq "$(CXX_TYPE)" ""
CXX_TYPE                                              := gcc
...
OSCI_SYSTEMC_INCLUDE                                  := /cad/mentor/2019.11/Catapult_Synthesis_10.4b-841621/Mgc_home/shared/include
export OSCI_SYSTEMC_INCLUDE
endif
ifeq "$(OSCI_SYSTEMC_LIB)" ""
OSCI_SYSTEMC_LIB                                      := /cad/mentor/2019.11/Catapult_Synthesis_10.4b-841621/Mgc_home/shared/lib/$(CXX_OS)/$(CXX_TYPE)
...
ifeq "$(VCS_VCS_HOME)" ""
VCS_VCS_HOME                                          := /afs/ir.stanford.edu/class/ee/synopsys/vcs/M-2017.03
export VCS_VCS_HOME
endif
